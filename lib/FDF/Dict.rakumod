...
role FDF::Dict
   ...
   # See [PDF 32000 Table 243 – Entries in the FDF dictionary]
    ...
    has PDF::COS::Name $.Encoding is entry;      #| (Optional; PDF 1.3) The encoding to be used for any FDF field value or option (V or Opt in the field dictionary; see Table 246) or field name that is a string and does not begin with the Unicode prefix U+FEFF. Default value: PDFDocEncoding.

    has FDF::Annot @.Annots is entry(:coerce(-> AnnotLike $a, $_ {.coerce: $a})); # Optional; PDF 1.3) An array of FDF annotation dictionaries
