...
role FDF::Field
    ...
    has PDF::AdditionalActions $.AA is entry(:alias<additional-actions>); #| (Optional) An additional-actions dictionary defining the field’s behavior in response to various trigger events
