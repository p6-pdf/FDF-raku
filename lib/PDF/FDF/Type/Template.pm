...
my role Template
    ...
    has PDF::FDF::Type::Field @.Fields is entry;  #| (Optional) An array of references to FDF field dictionaries describing the root fields to be imported (those with no ancestors in the field hierarchy). 
...
role PDF::FDF::Type::Template does Template {}
