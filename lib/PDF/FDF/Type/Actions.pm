...
my role Actions
    ...
    my subset ActionOrActions of PDF::DAO where { ($_ ~~ Array && $_[0] ~~ Actions) || $_ ~~ Hash };
...
role PDF::FDF::Type::Actions does Actions {}
role PDF::FDF::Type_Actions does Actions {}  # rakudo work-around - losing above symbol
